...
namespace Egret.Migrations
{
    ...
    [Migration("20180615205250_ConsumptionItems3")]
    partial class ConsumptionItems3
    {
            ...
            modelBuilder.Entity("Egret.Models.ConsumptionEvent", b =>
                {
                    ...
                    b.Property<string>("InventoryItemNavigationCode");
                    ...
                    b.HasIndex("InventoryItemNavigationCode");
            ...
            modelBuilder.Entity("Egret.Models.ConsumptionEvent", b =>
                {
                    b.HasOne("Egret.Models.InventoryItem", "InventoryItemNavigation")
                        ...
                        .HasForeignKey("InventoryItemNavigationCode")
